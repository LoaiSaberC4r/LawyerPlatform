...
public sealed class BilingualEmailNotificationFactoryTests
{
    ...
    {
        { EmailNotificationType.LawyerSubmittedForApproval, Lawyer(), "Lawyer Platform | طلب محامٍ جديد للمراجعة | New Lawyer Application", LawyerId.ToString() },
        { EmailNotificationType.LawyerApproved, Lawyer(), "Lawyer Platform | تم اعتماد حسابك | Your Profile Has Been Approved", "Approved" },
        { EmailNotificationType.LawyerChangesRequested, Lawyer("مراجعة آمنة"), "Lawyer Platform | مطلوب تعديلات على ملفك | Changes Required", "Changes Requested" },
        { EmailNotificationType.LawyerRejected, Lawyer("سبب آمن"), "Lawyer Platform | تحديث حالة طلب الاعتماد | Lawyer Application Update", "Rejected" },
        { EmailNotificationType.LawyerSuspended, Lawyer("سبب آمن"), "Lawyer Platform | تم تعليق حساب المحامي | Lawyer Profile Suspended", "Suspended" },
        { EmailNotificationType.LawyerReactivated, Lawyer(), "Lawyer Platform | تمت إعادة تفعيل ملفك | Your Lawyer Profile Has Been Reactivated", "Welcome back" },
        { EmailNotificationType.ConsultationRequestCreatedForLawyer, Consultation(), "Lawyer Platform | طلب استشارة جديد | New Consultation Request", "REF-2026-001" },
        { EmailNotificationType.ConsultationRequestCreatedConfirmation, Consultation(), "Lawyer Platform | تم استلام طلب الاستشارة | Consultation Request Received", "Current status" },
        { EmailNotificationType.ConsultationUnderReview, Consultation(), "Lawyer Platform | طلب الاستشارة قيد المراجعة | Consultation Under Review", "Under Review" },
        { EmailNotificationType.ConsultationApproved, Consultation(), "Lawyer Platform | تمت الموافقة على طلب الاستشارة | Consultation Request Approved", "Approved" },
        { EmailNotificationType.ConsultationRejected, Consultation("سبب آمن"), "Lawyer Platform | تحديث طلب الاستشارة | Consultation Request Update", "Rejected" },
        { EmailNotificationType.ConsultationCompleted, Consultation(), "Lawyer Platform | تم إكمال طلب الاستشارة | Consultation Completed", "Completed" },
        { EmailNotificationType.ClientSuspended, Client(), "Lawyer Platform | تم تعليق حسابك | Your Account Has Been Suspended", "Suspended" },
        { EmailNotificationType.ClientReactivated, Client(), "Lawyer Platform | تمت إعادة تفعيل حسابك | Your Account Has Been Reactivated", "Active" }
    };
