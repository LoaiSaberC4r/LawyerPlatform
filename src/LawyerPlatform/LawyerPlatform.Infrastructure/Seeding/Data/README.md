...
LawyerPlatform's three-level Egypt location hierarchy. They contain names and
...
embedded in `LawyerPlatform.Infrastructure.dll` and loaded with
`System.Text.Json`.
...
| Source level | LawyerPlatform level | Included units |
| --- | --- | --- |
